...
function TeamsStanding({ data }) {
  ...
  const renderDivisionTeams = div => {
    return div.teamRecords.map((team, i) => {
      return renderTeamRow(team, team.divisionRank);
    });
  };
    ...
    return (
      <table className="content-table">
        ...
        {wildCardTeams
          ...
          .map(team => {
            return renderTeamRow(team, team.wildCardRank);
          })}
      </table>
    );
  };
    ...
    return (
      <table className="content-table">
        ...
        {conferenceTeams
          ...
          .map(team => {
            return renderTeamRow(team, team.conferenceRank);
          })}
      </table>
    );
  };
    ...
    return (
      <table className="content-table">
        ...
        {leagueTeams
          ...
          .map(team => {
            return renderTeamRow(team, team.leagueRank);
          })}
      </table>
    );
  };
  ...
  } else return <h1>Preparing Standings...</h1>;
}
