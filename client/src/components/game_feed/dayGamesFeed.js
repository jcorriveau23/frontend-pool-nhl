        ...
        <div>
            <div className="dateSelector">
                <table>
                    <tbody>
                        <tr>
                            <td><img src={goPrev} onClick={prevDate} alt=""></img></td>
                            <td><DatePicker selected={date} onChange={(date) => setDate(date)} dateFormat="P"></DatePicker></td>
                            <td><img src={goNext} onClick={nextDate} alt=""></img></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div className="dayGamesFeed">
                <ul>
                    {gamesStats.map((game, i)  => {
                        return <Link to={'/gameFeed/' + game.gamePk} key={i}><li><GameItem gameData={game}></GameItem></li></Link>
                    })}
                </ul>
            </div>
        </div>
