...
router.post('/create_trade', PoolController.create_trade);
router.post('/cancel_trade', PoolController.cancel_trade);
router.post('/respond_trade', PoolController.respond_trade);
router.post('/fill_spot', PoolController.fill_spot);
